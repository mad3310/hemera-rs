...
@Service("taskCommonInvokeService")
public class TaskCommonInvokeServiceImpl extends BaseTaskCommonServiceImpl implements IBaseTaskService{
	
	private final static Logger logger = LoggerFactory.getLogger(TaskCommonInvokeServiceImpl.class);
